    ...
    data.forEach(entry => {
        ...
        if (mapElement) {
            ...
            if (value < minValue + range) {
                color = currentColorScheme[0];
            } else if (value < minValue + range * 2) {
                color = currentColorScheme[1];
            } else if (value < minValue + range * 3) {
                color = currentColorScheme[2];
            } else if (value < minValue + range * 4) {
                color = currentColorScheme[3];
            } else {
                color = currentColorScheme[4];
            }
